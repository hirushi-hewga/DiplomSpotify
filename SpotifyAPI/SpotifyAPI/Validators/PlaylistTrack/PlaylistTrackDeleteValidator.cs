...
public class PlaylistTrackDeleteValidator : AbstractValidator<PlaylistTrackDeleteVm>
{
    public PlaylistTrackDeleteValidator(IExistingEntityCheckerService existingEntityCheckerService)
    {
