...
const ResetPasswordPage1 = () => {
  ...
  // };
    ...
    return (
      <div className="w-[589px] h-[651px] flex flex-col items-center justify-between text-white">
        <div className="font-semibold font-poppins text-[58px] text-center text-[#FE7D1C]">RESET PASSWORD</div>
        <div className="w-full h-[442px] flex items-center justify-center rounded-[30px] backdrop-blur-[4px] border-white/[80%] border-[1px]">
          <div className="w-[520px] h-[309px] flex flex-col items-center justify-between">
            <div className="w-full h-[153px] flex flex-col justify-between">
              ...
              <div className="font-light font-poppins text-[18px]">
                If the email address is in our database, we will send you an email to reset your password. Need help?
                <span className="text-[16px]"> visit our Help Center.</span>
              </div>
            </div>
            <div className="w-full h-[124px] flex flex-col justify-between">
              <div className="w-full h-[52px]">
                <Button
                  onClick={() => navigate("/reset-password/password")}
                  className="bg-[#F3792A] font-medium text-[20px]"
                >
                  Sent reset link
                </Button>
              </div>
              <Link to="/login" className="w-full h-[52px] flex items-center justify-center font-normal font-poppins text-[18px]">Previous step</Link>
            </div>
          </div>
        </div>
